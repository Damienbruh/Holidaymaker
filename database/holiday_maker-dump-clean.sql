...
COPY public.addons (addons_id, addon, addon_price, hotel_fk) FROM stdin;
\.
...
COPY public.hotels (hotel_id, street_name, postal_code, city, region, country, distance_to_ski_slope, distance_to_town_center, rating, hotel_name) FROM stdin;
\.
